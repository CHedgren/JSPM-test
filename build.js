...
$__System.register('48', ['5', '6', '40', '47'], function (_export) {
    var _createClass, _classCallCheck, _Promise, jsonp, RedditApi;
                ...
                _createClass(RedditApi, [{
                    ...
                    value: function load() {
                        ...
                        return new _Promise(function (resolve, reject) {
                            jsonp(_this.redditURL, { param: 'jsonp' }, function (err, data) {
...
$__System.register('49', [], function (_export) {
       ...
       return {
              setters: [],
              execute: function () {
                     _export('default', function (posts) {
...
$__System.register('1', ['48', '49', '4a'], function (_export) {
    'use strict';

    var RedditApi, giffGiff, displayGifs;
    return {
        setters: [function (_) {
            RedditApi = _['default'];
        }, function (_2) {
            ...
            displayGifs = _a['default'];
        }],
        execute: function () {

            RedditApi.load().then(giffGiff).then(displayGifs);
        }
    };
});
})
